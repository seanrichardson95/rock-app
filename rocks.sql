...
INSERT INTO public.rocks VALUES (3, 'Granite', 'Igneous', 'Granite is a light-colored igneous rock with grains large enough to be visible with the unaided eye. It forms from the slow crystallization of magma below Earths surface. Granite is composed mainly of quartz and feldspar with minor amounts of mica, amphiboles, and other minerals. This mineral composition usually gives granite a red, pink, gray, or white color with dark mineral grains visible throughout the rock.');
